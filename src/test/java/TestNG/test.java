...
import PageOjectModel.ForgotPasswordPage;
import PageOjectModel.Home;
...
public class test {
    ...
    @Test
    public void testng() throws InterruptedException, IOException {
    ...
    public void Browsers(String window) throws InterruptedException {
        if (window.equalsIgnoreCase("Chrome")) {
            ...
            System.setProperty("webdriver.edge.driver", "C:\\Users\\fwzna\\IdeaProjects\\Mentoring\\src\\Drivers\\geckodriver.exe");
    ...
    public void Pictures() throws IOException {
        ...
        FileHandler.copy(screenshorts, new File("C:\\Users\\fwzna\\IdeaProjects\\Mentoring\\Pictures\\testng\\PicturesMonMon" + sk + "ShotOfPage.jpg"));
    }
}
